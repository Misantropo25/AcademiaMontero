...
<html lang="en">
  <head>
    ...
    <!-- CSS Estilo -->
    <link rel="stylesheet" type="text/css" href="../estilosCSS/estilosInscripcion.css"/>
        ...
        <nav>
            <div class="content_flex">
                <div id="content_icons">
                    <a href="menuEstudiante.php"><button class="btn_icon"><img class="icon" src="../Imagenes/Home.png" alt="" width="54" height="52"></button></a>
    ...
    <div class="fondo_comun">
      <div>
        ...
        <div >
          ...
          <table id="centro">
            <tr>
                <td id="columnap"><h3 class="tabla-1">Nombre Curso</h3></td>
                <td id="columnap"><h3>Horario</h3></td>
                <td id="columnap"><h3>Capacidad de Alumnos</h3></td>
                <td id="columnap"><label>Precio</label></td>
            </tr>
            <tr>
              <td id="columna"><h4>Curso 1</h4></td>
              <td id="columna"><h4>5:00 - 7:00 p.m.</h4></td>
              <td id="columna"><h4>10/20</h4></td>
              <td id="columna"><label>S/. 100</label></td>
              <td id="columna1"><input type="checkbox" /></td>
              
            </tr>
            <tr>
              <td id="columna"><h4>Curso 2</h4></td>
              <td id="columna"><h4>5:00 - 7:00 p.m.</h4></td>
              <td id="columna"><h4>16/20</h4></td>
              <td id="columna"><label>S/. 100</label></td>
              <td id="columna1"><input type="checkbox" /></td>
            </tr>
            <tr>
              <td id="columna"><h4>Curso 3</h4></td>
              <td id="columna"><h4>7:00 - 9:00 p.m.</h4></td>
              <td id="columna"><h4>20/20</h4></td>
              <td id="columna"><label>S/. 100</label></td>
              <td id="columna1"><input type="checkbox" /></td>
            </tr>
            <tr>
              <td id="columna"><h4>Curso 4</h4></td>
              <td id="columna"><h4>7:00 - 9:00 p.m.</h4></td>
              <td id="columna"><h4>18/20</h4></td>
              <td id="columna"><label>s/. 100</label></td>
              <td id="columna1"><input type="checkbox" /></td>
            </tr>
          </table>
        ...
        <div class="boton">
          <label>S/. 500</label>
          <a href="inscripcion copy.php"><label for="btn_modal" class="lbl_modal">Abrir Modal</label></a>
        </div>
        ...
        <div class="contenedor">
            ...
            <div class="contenido">
                <div class="conteiner_buttons">
                    <a href="pagoContado.php"><button><img src="./Icons/Home gradient.png"></button></a>
                    <a href="pagoEntidadBancaria.php"><button><img src="./Icons/Home Linear Gradient.png"></button></a>
                </div>
            </div>
        </div>
      </div>
